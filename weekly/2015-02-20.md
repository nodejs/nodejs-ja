...
* **url**: `url.resolve('/path/to/file', '.')`の戻り値が`/path/to/`のようにトレイリングスラッシュ付きに、`url.resolve('/', '.')` の戻り値は`/`に変更。[#278](https://github.com/iojs/io.js/pull/278) (Amir Saboury)
...
* **LTTng Basics** - asciinemaユーザー jgalar によるio.jsでの[LTTing Basics](https://asciinema.org/a/16785)

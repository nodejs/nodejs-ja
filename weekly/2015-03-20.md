...
* **npm**: npm のバージョンを 2.7.1 にアップグレードしました。詳細は  [npm CHANGELOG.md](https://github.com/npm/npm/blob/master/CHANGELOG.md#v271-2015-03-05) にて。要約:
  ...
  * [`4ef1412`](https://github.com/npm/npm/commit/4ef1412d00) [#7075](https://github.com/npm/npm/issues/7075) もしあなたが正しい semver のレンジで release のタグを付け、`npm publish` と `npm tag` は早い段階で手続きがエラーになります。([@smikes](https://github.com/smikes))
